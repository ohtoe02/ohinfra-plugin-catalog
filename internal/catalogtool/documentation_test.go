...
func TestAuthorDocumentationLayout(t *testing.T) {
	...
	required := []string{
		...
		"docs/release-metadata-v1.md",
		"docs/validation.md",
		"contracts/protocol-v1/README.md",
		"contracts/protocol-v1/SHA256SUMS",
		"contracts/protocol-v1/manifest.schema.json",
		"contracts/protocol-v1/invocation.schema.json",
		"contracts/protocol-v1/plan.schema.json",
